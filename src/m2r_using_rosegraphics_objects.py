...
#            waits the amount of seconds specified
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            less cluttered? Also allows you to observe the results as long as wanted
#
